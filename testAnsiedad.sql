...
INSERT INTO `user` VALUES (1,'admin','','','','admin@gmail.com','admin',1,0,0),(2,'mary','','','','mary@example.com','password2',0,0,0),(3,'alex','','','','alex@example.com','password3',1,0,0),(4,'emily','','','','emily@example.com','password4',0,0,0),(5,'david','','','','david@example.com','password5',1,0,0),(6,'eder','','','','eder@example.com','edercito',1,0,0),(12,'abcd',NULL,NULL,NULL,'abcd','abcd',1,0,0),(13,'asdf',NULL,NULL,NULL,'asdf','asdf',0,0,0),(14,'',NULL,NULL,NULL,'','',1,0,0),(15,'eder',NULL,NULL,NULL,'eder','eder',1,0,0),(16,'luis',NULL,NULL,NULL,'luis','luis',1,0,0),(17,'carlos',NULL,NULL,NULL,'carlos','carlos',1,0,0);
...
-- Dump completed on 2023-05-28  2:44:36
